...
const MonthlyCollectionScreen = ({ navigation }) => {
  ...
  const fetchMonthlyCollections = async () => {
    try {
      ...
      Alert.alert('Error', 'Failed to load monthly collections');
    } finally {
      setLoading(false);
    }
  };
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text variant="bodyMedium" style={styles.subtitle}>
          Collection report for {selectedMonth}
        </Text>
      </View>

      {/* Month and Project Selector */}
      <Card style={styles.card}>
        <Card.Content>
          <Text variant="titleMedium" style={styles.sectionTitle}>
            Select Month & Project
          </Text>
          <TextInput
            mode="outlined"
            label="Month"
        ...
        <Card.Content>
          ...
          {filteredCollections.length > 0 ? (
            ...
            <EmptyState
              ...
              description="No collections found for the selected month and project"
            />
          )}
        </Card.Content>
      </Card>
...
export default MonthlyCollectionScreen;
